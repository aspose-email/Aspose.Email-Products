---
title: Convert MBOX to PST via C++ application 
weight: 2950
url: /cpp/conversion/mbox-to-pst/ 
description: Sample C++ conversion code for MBOX document to PST format. Use example code for batch MBOX to PST conversion within any C++ Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MBOX to PST in C++" h2="High performance MBOX to PST conversion using Aspose.Email for C++ library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PST" pfName="Aspose.Email" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MBOX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Email API makes it easy for the developers to convert MBOX file to PST in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Convert MBOX to PST - C++‎" offSpacer="" %}}
