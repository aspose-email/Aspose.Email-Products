---
title: Convert MBOX to OFT via C++ application 
weight: 2680
url: /cpp/conversion/mbox-to-oft/ 
description: Sample C++ conversion code for MBOX document to OFT format. Use example code for batch MBOX to OFT conversion within any C++ Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MBOX to OFT in C++" h2="High performance MBOX to OFT conversion using Aspose.Email for C++ library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OFT" pfName="Aspose.Email" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MBOX" >}}
...
{{% blocks/products/pf/agp/code-block title="Convert MBOX to OFT - C++‎" offSpacer="" %}}
