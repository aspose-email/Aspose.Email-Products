---
title: Convert MBOX to OST via C++ application 
weight: 3270
url: /cpp/conversion/mbox-to-ost/ 
description: Sample C++ conversion code for MBOX document to OST format. Use example code for batch MBOX to OST conversion within any C++ Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MBOX to OST in C++" h2="High performance MBOX to OST conversion using Aspose.Email for C++ library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OST" pfName="Aspose.Email" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MBOX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MBOX to OST Using C++" %}}

 In order to convert MBOX to OST, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MBOX to OST via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Convert MBOX to OST - C++‎" offSpacer="" %}}
