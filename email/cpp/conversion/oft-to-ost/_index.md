---
title: Convert OFT to OST via C++ application 
weight: 920
url: /cpp/conversion/oft-to-ost/ 
description: Sample C++ conversion code for OFT document to OST format. Use example code for batch OFT to OST conversion within any C++ Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OFT to OST in C++" h2="High performance OFT to OST conversion using Aspose.Email for C++ library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OST" pfName="Aspose.Email" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OFT" >}}
...
{{% blocks/products/pf/agp/code-block title="Convert OFT to OST - C++‎" offSpacer="" %}}
