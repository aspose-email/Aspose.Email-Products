---
title: .NET Java C++ Python et API de traitement des e-mails Android 
weight: 10
url: /fr/family
description: Créer lire manipuler des fichiers Outlook et Thunderbird en utilisant la bibliothèque appropriée de n'importe quelle plate-forme. Envoyer ou recevoir des e-mails depuis SMTP MIME POP3 HTTP IMAP
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API de gestion et de transmission des e-mails" h2="API natives pour créer, manipuler et convertir des fichiers de messagerie et de stockage Outlook. Implémentez des protocoles réseau tels que SMTP, POP3 et IMAP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email.svg" pfName="Aspose.Email" downloadUrl="https://downloads.aspose.com/email" tryOnlineUrl="" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi la famille de produits Aspose.Email ?" tabId="success-stories" >}}
