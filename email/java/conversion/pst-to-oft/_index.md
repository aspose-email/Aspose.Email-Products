---
title: Convert PST to OFT via Java 
weight: 1000
url: /java/conversion/pst-to-oft/ 
description: Sample Java conversion code for PST format to OFT file. Use this example code to export message to OFT within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PST to OFT in Java" h2="Native PST to OFT conversion using Aspose.Email for Java library, without needing any additional software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OFT" pfName="Aspose.Email" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PST to OFT Using Java" %}}

 In order to render PST to OFT, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PST to OFT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Email API makes it easy for the developers to convert PST file to OFT in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

+  Load PST file with PersonalStorage.fromFile.
+  Call the saveAs() method having two parameters.
+  Output OFT file and FileFormat.Pst as parameters.
...
{{% blocks/products/pf/agp/code-block title="Convert PST to OFT - Java‎" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PST to OFT Conversion Live Demos" sectionDescription="[Convert PST to OFT](https://products.aspose.app/email/conversion/pst-to-oft) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your PST file, it will be converted instantly to OFT." >}}
