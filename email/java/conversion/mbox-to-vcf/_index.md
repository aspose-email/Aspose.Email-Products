---
title: Convert MBOX to VCF via Java 
weight: 3530
url: /java/conversion/mbox-to-vcf/ 
description: Sample Java conversion code for MBOX format to VCF file. Use this example code to export message to VCF within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MBOX to VCF in Java" h2="Native MBOX to VCF conversion using Aspose.Email for Java library, without needing any additional software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VCF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MBOX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MBOX to VCF Using Java" %}}

 In order to render MBOX to VCF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MBOX to VCF via Java" %}}
