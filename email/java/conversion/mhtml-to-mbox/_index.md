---
title: Convert MHTML to MBOX via Java 
weight: 3080
url: /java/conversion/mhtml-to-mbox/ 
description: Sample Java conversion code for MHTML format to MBOX file. Use this example code to export message to MBOX within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MHTML to MBOX in Java" h2="Native MHTML to MBOX conversion using Aspose.Email for Java library, without needing any additional software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MBOX" pfName="Aspose.Email" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MHTML to MBOX Using Java" %}}

 In order to render MHTML to MBOX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MHTML to MBOX via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Convert MHTML to MBOX - Java‎" offSpacer="" %}}
