---
title: Convert MHTML to VCF via Java 
weight: 3870
url: /java/conversion/mhtml-to-vcf/ 
description: Sample Java conversion code for MHTML format to VCF file. Use this example code to export message to VCF within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MHTML to VCF in Java" h2="Native MHTML to VCF conversion using Aspose.Email for Java library, without needing any additional software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VCF" pfName="Aspose.Email" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MHTML to VCF Using Java" %}}

 In order to render MHTML to VCF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MHTML to VCF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Email API makes it easy for the developers to convert MHTML file to VCF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Convert MHTML to VCF - Java‎" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="MHTML to VCF Conversion Live Demos" sectionDescription="[Convert MHTML to VCF](https://products.aspose.app/email/conversion/mhtml-to-vcf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your MHTML file, it will be converted instantly to VCF." >}}
