---
title: Convert OST to PST via Java 
weight: 490
url: /java/conversion/ost-to-pst/ 
description: Sample Java conversion code for OST format to PST file. Use this example code to export message to PST within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OST to PST in Java" h2="Native OST to PST conversion using Aspose.Email for Java library, without needing any additional software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PST" pfName="Aspose.Email" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OST" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert OST to PST Using Java" %}}

 In order to render OST to PST, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert OST to PST via Java" %}}
