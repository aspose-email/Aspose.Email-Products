---
title: Convert OST to OFT via Java 
weight: 1260
url: /java/conversion/ost-to-oft/ 
description: Sample Java conversion code for OST format to OFT file. Use this example code to export message to OFT within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OST to OFT in Java" h2="Native OST to OFT conversion using Aspose.Email for Java library, without needing any additional software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OFT" pfName="Aspose.Email" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OST" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert OST to OFT Using Java" %}}

 In order to render OST to OFT, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert OST to OFT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Email API makes it easy for the developers to convert OST file to OFT in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

+  Load OST file with PersonalStorage.fromFile.
+  Call the saveAs() method having two parameters.
+  Output OFT file and FileFormat.Ost as parameters.
...
{{% blocks/products/pf/agp/code-block title="Convert OST to OFT - Java‎" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="OST to OFT Conversion Live Demos" sectionDescription="[Convert OST to OFT](https://products.aspose.app/email/conversion/ost-to-oft) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your OST file, it will be converted instantly to OFT." >}}
