---
title: Convert PST to HTML via Java 
weight: 3680
url: /java/conversion/pst-to-html/ 
description: Sample Java conversion code for PST format to HTML file. Use this example code to export message to HTML within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PST to HTML in Java" h2="Native PST to HTML conversion using Aspose.Email for Java library, without needing any additional software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="Aspose.Email" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PST to HTML Using Java" %}}

 In order to render PST to HTML, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PST to HTML via Java" %}}
...
+  Output HTML file and FileFormat.Pst as parameters.
...
{{% blocks/products/pf/agp/code-block title="Convert PST to HTML - Java‎" offSpacer="" %}}
