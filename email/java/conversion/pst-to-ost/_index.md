---
title: Convert PST to OST via Java 
weight: 1410
url: /java/conversion/pst-to-ost/ 
description: Sample Java conversion code for PST format to OST file. Use this example code to export message to OST within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PST to OST in Java" h2="Native PST to OST conversion using Aspose.Email for Java library, without needing any additional software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OST" pfName="Aspose.Email" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PST to OST Using Java" %}}

 In order to render PST to OST, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PST to OST via Java" %}}
