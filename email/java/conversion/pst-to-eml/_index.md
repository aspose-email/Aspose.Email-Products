---
title: Convert PST to EML via Java 
weight: 1090
url: /java/conversion/pst-to-eml/ 
description: Sample Java conversion code for PST format to EML file. Use this example code to export message to EML within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PST to EML in Java" h2="Native PST to EML conversion using Aspose.Email for Java library, without needing any additional software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EML" pfName="Aspose.Email" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PST to EML Using Java" %}}

 In order to render PST to EML, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PST to EML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Email API makes it easy for the developers to convert PST file to EML in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

+  Load PST file with PersonalStorage.fromFile.
+  Call the saveAs() method having two parameters.
+  Output EML file and FileFormat.Pst as parameters.
...
{{% blocks/products/pf/agp/code-block title="Convert PST to EML - Java‎" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PST to EML Conversion Live Demos" sectionDescription="[Convert PST to EML](https://products.aspose.app/email/conversion/pst-to-eml) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your PST file, it will be converted instantly to EML." >}}
