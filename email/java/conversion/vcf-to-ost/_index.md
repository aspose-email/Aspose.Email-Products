---
title: Convert VCF to OST via Java 
weight: 280
url: /java/conversion/vcf-to-ost/ 
description: Sample Java conversion code for VCF format to OST file. Use this example code to export message to OST within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert VCF to OST in Java" h2="Native VCF to OST conversion using Aspose.Email for Java library, without needing any additional software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OST" pfName="Aspose.Email" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VCF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert VCF to OST Using Java" %}}

 In order to render VCF to OST, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert VCF to OST via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Convert VCF to OST - Java‎" offSpacer="" %}}
