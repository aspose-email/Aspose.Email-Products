---
title: Convert OST to MBOX via Java 
weight: 1590
url: /java/conversion/ost-to-mbox/ 
description: Sample Java conversion code for OST format to MBOX file. Use this example code to export message to MBOX within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OST to MBOX in Java" h2="Native OST to MBOX conversion using Aspose.Email for Java library, without needing any additional software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MBOX" pfName="Aspose.Email" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OST" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert OST to MBOX Using Java" %}}

 In order to render OST to MBOX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert OST to MBOX via Java" %}}
