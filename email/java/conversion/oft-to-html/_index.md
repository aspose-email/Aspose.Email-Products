...
description: Sample Java conversion code for OFT format to HTML file. Use this example code to export message to HTML within any Web or Desktop Java based application.
---
