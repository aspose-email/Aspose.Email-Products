---
title: Convert ICS to OST via Java 
weight: 2940
url: /java/conversion/ics-to-ost/ 
description: Sample Java conversion code for ICS format to OST file. Use this example code to export message to OST within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ICS to OST in Java" h2="Native ICS to OST conversion using Aspose.Email for Java library, without needing any additional software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OST" pfName="Aspose.Email" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ICS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert ICS to OST Using Java" %}}

 In order to render ICS to OST, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert ICS to OST via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Convert ICS to OST - Java‎" offSpacer="" %}}
