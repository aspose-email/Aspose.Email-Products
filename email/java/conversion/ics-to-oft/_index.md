---
title: Convert ICS to OFT via Java 
weight: 2320
url: /java/conversion/ics-to-oft/ 
description: Sample Java conversion code for ICS format to OFT file. Use this example code to export message to OFT within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ICS to OFT in Java" h2="Native ICS to OFT conversion using Aspose.Email for Java library, without needing any additional software." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OFT" pfName="Aspose.Email" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ICS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert ICS to OFT Using Java" %}}

 In order to render ICS to OFT, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert ICS to OFT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Convert ICS to OFT - Java‎" offSpacer="" %}}
