---
title: Java 電子郵件 API | Java Outlook API |接收和解析電子郵件 
weight: 2670
url: /zh-hant/java/ 
description: Aspose.Email Java。 Mail、MIME 和 iCalander SDK for Java 用於發送和接收 Thunderbird 和 Outlook 電子郵件。 API 適用於 SMTP 服務器 POP3 IMAP 客戶端 電子郵件 API
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="用於電子郵件處理的 Java Outlook API 和 Java Thunderbird API" h2="無需其他軟件即可從 Outlook 和 Thunderbird 生成電子郵件、發送電子郵件和解析電子郵件。通過 SMTP、POP3、IMAP 協議發送和接收電子郵件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/headers/aspose_email-for-java.svg" pfName="Aspose.Email" subTitlepfName="for Java" downloadUrl="https://downloads.aspose.com/email/java" >}}
...
<p>
 Aspose.Email for Java 允許開發人員專注於實現自己的業務邏輯來管理電子郵件，而無需了解格式規範或網絡編程。
</p>
...
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="電子郵件 API Java" src="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg"/>
  <header>
   Aspose.Email
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="Aspose.Email for Java 只需要 Java 就可以工作。" >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Java API Outlook 太平洋標準時間" src="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg"/>
  <header>
   Aspose.Email
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="支持的文件格式" description="Aspose.Email for Java 支持最常用的消息和消息存儲格式等 [文件格式](https://docs.aspose.com/email/java/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="用於電子郵件發送的 Java API" src="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg"/>
  <header>
   Aspose.Email
  </header>
  <footer>
...
message.save(dir + "output.mhtml", SaveOptions.getDefaultMhtml());</code></pre>
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     ...
     <pre><code class="java">// 初始化 SmtpClient 對象
...
{{< blocks/products/pf/slr-element name="文檔" href="https://docs.aspose.com/email/java/" >}}
{{< blocks/products/pf/slr-element name="源代碼" href="https://github.com/aspose-email/Aspose.Email-for-Java" >}}
{{< blocks/products/pf/slr-element name="API 參考" href="https://apireference.aspose.com/email/java" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼選擇 Aspose.Email for Java？" tabId="success-stories" >}}
