...
<p>
 Aspose.Email для Android через Java позволяет разработчикам программного обеспечения создавать приложения для Android, имеющие возможность управлять почтовыми сообщениями и манипулировать ими, не запутываясь в сложностях реализации формата файлов Microsoft Outlook. Библиотека электронной почты Android помогает разработчикам управлять форматами почтовых файлов из приложений Android. API не имеет никаких зависимостей, кроме Android Runtime, поэтому для работы ему не нужны никакие другие API или программное обеспечение.
</p>

<p>
 Aspose.Email для Android через Java предоставляет инструменты, необходимые для создания, чтения и управления файлами Outlook MSG, PST, EML и MHT из приложения Android. Он предоставляет возможность манипулировать заголовками сообщений, содержимым, вложениями и свойствами Mapi в соответствии со спецификациями приложения.
</p>
...
<div class="diagram1 d1-android">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API электронной почты Android" src="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-android-java.svg"/>
  <header>
   Aspose.Email
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Независимость от платформы" description="Aspose.Email работает на любой платформе, на которой установлена среда выполнения Android." >}}
<div class="diagram1 d1-android">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Почтовый API Outlook" src="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-android-java.svg"/>
  <header>
   Aspose.Email
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Поддерживаемые форматы файлов" description="API поддерживает большинство популярных форматов файлов сообщений и хранилищ." >}}
<div class="diagram1 d2 d1-android">
 <div class="d1-row">
  ...
  <!--/row-->
  <div class="d1-logo">
   <img width="70" height="75" alt="Почтовый API для Android" src="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-android-java.svg"/>
   <header>
    Aspose.Email
   </header>
   <footer>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Чтение и управление различными типами сообщений через API продукта
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Добавлять, удалять или извлекать вложения из сообщений
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Расчет даты и времени для сложных шаблонов повторения
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Создание и использование шаблонов повторения в iCalendar (RFC 2445)
    </p>
   </div>
   <div class="col-lg-4">
...
-->
   <div class="col-lg-12">
    ...
    <p>
     Библиотека упрощает преобразование различных форматов файлов сообщений. Процесс преобразования заключается в загрузке исходного файла в объектную модель API и вызове функции сохранения с соответствующими параметрами. Это действительно так просто!
    </p>
...
msge.save(SD_PATH + "output.mhtml", SaveOptions.getDefaultMhtml());</code></pre>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Чтение свойств Outlook MAPI
    </h2>
    <p>
     Библиотека Outlook для Android позволяет читать свойства MAPI файла MSG. Он поддерживает чтение всех свойств MAPI или чтение определенного свойства с помощью тега свойства MAPI.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/offers-section pfName="Aspose.Email " description="Aspose.Email предлагает индивидуальные почтовые API для других популярных сред разработки, перечисленных ниже:" >}}
