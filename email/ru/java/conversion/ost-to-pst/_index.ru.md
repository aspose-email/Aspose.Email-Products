...
{{% blocks/products/pf/agp/content h2="Как конвертировать OST в PST с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для преобразования OST в PST через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Программисты Java могут легко преобразовать файл OST в PST всего за несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

+  Загрузите файл OST с PersonalStorage.fromFile.
+  Вызовите метод saveAs() с двумя параметрами.
+  Выходной файл PST и FileFormat.Ost в качестве параметров.
...
{{% blocks/products/pf/agp/code-block title="Преобразование OST в PST — Java" offSpacer="" %}}
