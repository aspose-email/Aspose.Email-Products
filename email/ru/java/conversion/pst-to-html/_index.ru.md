---
title: Преобразование PST в HTML через Java
weight: 3680
url: /ru/java/conversion/pst-to-html/
description: Пример кода преобразования Java для формата PST в файл HTML. Используйте этот пример кода для экспорта сообщения в HTML в любом веб-приложении или приложении для рабочего стола на основе Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование PST в HTML на Java" h2="Встроенное преобразование PST в HTML с использованием библиотеки электронной почты Java без необходимости в дополнительном программном обеспечении." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2="Как конвертировать PST в HTML с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для преобразования PST в HTML через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-программисты могут легко преобразовать файл PST в HTML, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

+  Загрузите файл PST с PersonalStorage.fromFile.
+  Вызовите метод saveAs() с двумя параметрами.
+  Выходной файл HTML и FileFormat.Pst в качестве параметров.
...
{{% blocks/products/pf/agp/code-block title="Преобразование PST в HTML — Java" offSpacer="" %}}
