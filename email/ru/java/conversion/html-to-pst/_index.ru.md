...
{{% blocks/products/pf/agp/content h2="Как конвертировать HTML в PST с помощью Java" %}}

 Чтобы отобразить HTML в PST, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для преобразования HTML в PST через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-программисты могут легко конвертировать HTML-файл в PST всего за несколько строк кода.
...
{{% blocks/products/pf/agp/code-block title="Преобразование HTML в PST — Java" offSpacer="" %}}
