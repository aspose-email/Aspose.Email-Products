---
title: Создание отчетов в файлах MSG с помощью Java
weight: 480
url: /ru/java/assembly/msg/
description: Пример кода Java для создания отчетов в формате MSG в среде выполнения Java для приложений JSP/JSF и настольных приложений.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Массовая генерация отчетов в формате MSG через Java" h2="Массовое создание сообщений электронной почты MSG без использования Outlook или Thunderbird." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MSG" pfName="Aspose.Email" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MSG" >}}
...
{{% blocks/products/pf/agp/content h2="Как создавать отчеты MSG с помощью Java" %}}

 Для создания отчетов файлов MSG мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для создания отчетов MSG через Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Массовое создание сообщений msg_Upper — C#" offSpacer="" %}}
