...
{{% blocks/products/pf/agp/content h2="Как создавать отчеты на основе PST с помощью C#" %}}

 Для создания отчетов PST мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по сборке PST через C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Пример кода C# для создания отчета о сообщениях PST" offSpacer="" %}}
