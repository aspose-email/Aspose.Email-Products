---
title: Конвертировать ICS в OFT через C#
weight: 3950
url: /ru/net/conversion/ics-to-oft/
description: Пример кода для преобразования ICS в OFT C#. Используйте пример кода API для пакетного преобразования файлов ICS в OFT в VB.NET, Asp.NET или любом приложении на основе .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Конвертировать ICS в OFT через C#" h2="Преобразование ICS в OFT C# с использованием .NET API без использования Outlook® или Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OFT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ICS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Программисты .NET могут легко загружать и преобразовывать файлы ICS в формат OFT, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

+  Загрузите файл ICS с помощью Calendar.Appointment.Load.
+  Сохранить как MSG в MemoryStream.
+  Загрузите из MemoryStream в MapiMessage.
+  Вызовите метод MapiMessage.Save.
...
{{% blocks/products/pf/agp/code-block title="В этом примере кода показано преобразование ICS в OFT C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Бесплатное приложение для конвертации ICS в OFT" sectionDescription="Проверьте наши живые демонстрации для [Преобразование ICS в OFT](https://products.aspose.app/email/conversion/ics-to-oft) со следующими преимуществами." >}}
