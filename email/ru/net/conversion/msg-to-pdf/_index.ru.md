---
title: Конвертировать MSG в PDF через C#
url: /ru/net/conversion/msg-to-pdf/
description: Пример кода для преобразования MSG в PDF C#. Используйте пример кода API для пакетного преобразования файлов MSG в PDF в VB.NET, Asp.NET или любом приложении на основе .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Конвертировать MSG в PDF через C#" h2="Преобразование MSG в PDF без установки Microsoft® Outlook® или Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="MSG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для преобразования MSG в PDF с помощью С#" %}}

{{% blocks/products/pf/agp/text %}}

 Программисты .NET могут легко загружать и преобразовывать файлы MSG в PDF, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите исходный файл MSG с помощью MailMessage.Load
1. Сохраните MSG как MHTML в MemoryStream, используя метод MailMessage.Save.
1. Загрузите MHTML из MemoryStream с помощью конструктора Aspose.Words.Document
1. Вызовите метод Document.Save при указании PdfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="В этом примере кода показано преобразование MSG в PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Бесплатное приложение для преобразования MSG в PDF" sectionDescription="Проверьте наши живые демонстрации для [Преобразование MSG в PDF](https://products.aspose.app/email/conversion/msg-to-pdf) со следующими преимуществами." >}}
