...
{{% blocks/products/pf/agp/text %}}
 ...
 Программисты на C++ могут легко преобразовать файл MHTML в PST всего за несколько строк кода.
...
{{% blocks/products/pf/agp/code-block title="Преобразование MHTML в PST — C++" offSpacer="" %}}

```cs
// Load the MHTML.
System::SharedPtr<MailMessage> mhtml = MailMessage::Load(u"sourceFile.mhtml");
// Save in PST
mhtml->Save(u"convertedFile.pst", SaveOptions::get_DefaultPst()); 
