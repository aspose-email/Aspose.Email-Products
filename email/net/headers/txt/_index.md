...
{{% blocks/products/pf/agp/content h2="How to Analyze TXT Header Using C#" %}}
 ...
 In order to analyze email TXT header, weвЂ™ll use
...
{{% blocks/products/pf/agp/code-block title="AnalyzeВ TXT Headers - C#" offSpacer="" %}}
