---
title: Convert PST to OTT via C# 
url: /net/conversion/pst-to-ott/ 
description: Sample code for PST to OTT C# conversion. Use API example code for batch PST files to OTT conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PST to OTT C# Conversion" offSpacer="" %}}
