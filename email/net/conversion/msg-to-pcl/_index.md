---
title: Convert MSG to PCL via C# 
url: /net/conversion/msg-to-pcl/ 
description: Sample code for MSG to PCL C# conversion. Use API example code for batch MSG files to PCL conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MSG to PCL C# Conversion" offSpacer="" %}}
