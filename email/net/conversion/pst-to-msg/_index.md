...
{{% blocks/products/pf/agp/content h2=".NET API for PST to MSG conversion without needing Outlook" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 makes it easy for the developers to load & convert PST files to MSG in just a few lines of code.
