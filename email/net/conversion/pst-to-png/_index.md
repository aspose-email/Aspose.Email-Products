---
title: Convert PST to PNG via C# 
url: /net/conversion/pst-to-png/ 
description: Sample code for PST to PNG C# conversion. Use API example code for batch PST files to PNG conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PST to PNG via C#" h2="Convert PST to PNG without needing Microsoft® Outlook® or Thunderbird® installed." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.EMAIL" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PST to PNG Using C#" %}}

In order to convert PST to PNG, we’ll use <a href="https://products.aspose.com/email/net">Aspose.Email for .NET</a> API which is a feature-rich, powerful and easy to use document manipulation and conversion API for C# platform. Open <a href="https://www.nuget.org/packages/aspose.email">NuGet</a> package manager, search for <b>Aspose.Email</b> and install. You may also use the following command from the Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PST to PNG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.EMAIL makes it easy for the developers to load & convert PST files to PNG in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1. Load PST file with PersonalStorage.FromFile
1. Call the SaveAs method
1. Pass output PNG file and FileFormat.Png as parameters
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PST to PNG C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PST to PNG" sectionDescription="Check our live demos for [PST to PNG conversion](https://products.aspose.app/email/conversion/pst-to-png) with following benefits." >}}
