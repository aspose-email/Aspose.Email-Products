---
title: Convert MHTML to OFT via C# 
weight: 760
url: /net/conversion/mhtml-to-oft/ 
description: Sample code for MHTML to OFT C# conversion. Use API example code for batch MHTML files to OFT conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MHTML to OFT via C#" h2="MHTML to OFT C# conversion using .NET API without needing Outlook® or Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OFT" pfName="Aspose.Email" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2=".NET API for MHTML to OFT conversion without needing Outlook" %}}
 ...
 In order to convert MHTML to OFT, we’ll use
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MHTML to OFT C# Conversion" offSpacer="" %}}
