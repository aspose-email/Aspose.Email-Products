...
{{% blocks/products/pf/agp/content h2=".NET API for MSG to MBOX conversion without needing Outlook" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 makes it easy for the developers to load & convert MSG files to MBOX in just a few lines of code.
