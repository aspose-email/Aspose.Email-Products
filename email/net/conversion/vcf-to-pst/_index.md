...
{{% blocks/products/pf/agp/content h2=".NET API for VCF to PST conversion without needing Outlook" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 makes it easy for the developers to load & convert VCF files to PST in just a few lines of code.
