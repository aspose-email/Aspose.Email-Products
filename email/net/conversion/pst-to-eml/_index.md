---
title: Convert PST to EML via C# 
weight: 380
url: /net/conversion/pst-to-eml/ 
description: Sample code for PST to EML C# conversion. Use API example code for batch PST files to EML conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PST to EML via C#" h2="PST to EML C# conversion using .NET API without needing Outlook® or Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EML" pfName="Aspose.Email" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2=".NET API for PST to EML conversion without needing Outlook" %}}
 ...
 In order to convert PST to EML, we’ll use
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PST to EML C# Conversion" offSpacer="" %}}
