...
title:  
weight: 3460
url: /net/conversion/pst-to-ost/ 
description: Try our On-Premise APIs with your message on .NET Framework, .NET Core, and Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PST to OST via C#" h2=".NET API for PST to OST conversion without needing OutlookВ® or ThunderbirdВ®." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/email/272x272/aspose_email-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="OST" pfName="" subTitlepfName="C# Code for PST to OST Conversion" downloadUrl="" fileiconsmall1="EML" fileiconsmall2="MSG" fileiconsmall3="PST" fileiconsmall4="MBOX" fileiconsmall5="PST" >}}
...
1.  Output OST file and FileFormat.Ost as parameters
...
{{< blocks/products/pf/agp/faq imgSrc="https://www.aspose.com/templates/brand/images/email/aspose_email-brand.png" >}}
    ...
    {{< blocks/products/pf/agp/faq-item question="Can I convert PST to OST via Java & C++?" answer="Aspose.Email is available for all major programming environments. Checkout [Java](https://products.aspose.com/email/java/conversion/pst-to-ost) and [C++](https://products.aspose.com/email/cpp/conversion/pst-to-ost) source code snippets for PST to OST conversion." >}}
    {{< blocks/products/pf/agp/faq-item question="Can I convert PST to OST on other platforms?" answer="You can execute the code with .NET Framework, .NET Core, and Xamarin Platforms." >}}
    {{< blocks/products/pf/agp/faq-item question="I do not have time to set up. Do you have a quick demo that I can try?" answer="Indeed. Try [PST to OST Conversion Demo](https://products.aspose.app/email/conversion/pst-to-ost) to quickly check the conversion results." >}}
