---
title: Convert PST to OST via C# 
weight: 120
url: /net/conversion/pst-to-ost/ 
description: Sample code for PST to OST C# conversion. Use API example code for batch PST files to OST conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PST to OST via C#" h2="PST to OST C# conversion using .NET API without needing Outlook® or Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OST" pfName="Aspose.Email" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2=".NET API for PST to OST conversion without needing Outlook" %}}

 In order to convert PST to OST, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PST to OST via C#" %}}

{{% blocks/products/pf/agp/text %}}

 The
 [aspose.email.dll](https://downloads.aspose.com/email/net) 
 makes it easy for the developers to load & convert PST files to OST in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

+  Load PST file with PersonalStorage.FromFile.
+  Call the SaveAs method having two parameters.
+  Output OST file and FileFormat.Ost as parameters.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PST to OST C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PST to OST" sectionDescription="Check our live demos for [PST to OST conversion](https://products.aspose.app/email/conversion/pst-to-ost) with following benefits." >}}
    ...
    {{% blocks/products/pf/agp/content h2="How to Convert PST to OST Using C#" %}}
