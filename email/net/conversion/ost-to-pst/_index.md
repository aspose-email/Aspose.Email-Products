---
title: Convert OST to PST via C# 
weight: 1870
url: /net/conversion/ost-to-pst/ 
description: Sample code for OST to PST C# conversion. Use API example code for batch OST files to PST conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert OST to PST via C#" h2="OST to PST C# conversion using .NET API without needing Outlook® or Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PST" pfName="Aspose.Email" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OST" >}}
...
{{% blocks/products/pf/agp/content h2=".NET API for OST to PST conversion without needing Outlook" %}}

 In order to convert OST to PST, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 makes it easy for the developers to load & convert OST files to PST in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows OST to PST C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert OST to PST" sectionDescription="Check our live demos for [OST to PST conversion](https://products.aspose.app/email/conversion/ost-to-pst) with following benefits." >}}
