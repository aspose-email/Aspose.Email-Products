---
title: Convert PST to DOCM via C# 
url: /net/conversion/pst-to-docm/ 
description: Sample code for PST to DOCM C# conversion. Use API example code for batch PST files to DOCM conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PST to DOCM via C#" h2="Convert PST to DOCM without needing Microsoft® Outlook® or Thunderbird® installed." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PST to DOCM Using C#" %}}

In order to convert PST to DOCM, we’ll use <a href="https://products.aspose.com/email/net">Aspose.Email for .NET</a> API which is a feature-rich, powerful and easy to use document manipulation and conversion API for C# platform. Open <a href="https://www.nuget.org/packages/aspose.email">NuGet</a> package manager, search for <b>Aspose.Email</b> and install. You may also use the following command from the Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PST to DOCM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmers can easily load & convert PST files to DOCM in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PST to DOCM C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PST to DOCM" sectionDescription="Check our live demos for [PST to DOCM conversion](https://products.aspose.app/email/conversion/pst-to-docm) with following benefits." >}}
