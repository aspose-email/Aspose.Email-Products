---
title: Converta EML para PCL via C#
url: /pt/net/conversion/eml-to-pcl/
description: Código de amostra para conversão de EML para PCL C#. Use o código de exemplo da API para arquivos EML em lote para conversão PCL em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converta EML para PCL via C#" h2="Converta EML para PCL sem precisar do Microsoft® Outlook® ou Thunderbird® instalado." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PCL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="EML" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter EML em PCL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos EML para PCL em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de EML para PCL C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter EML para PCL" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de EML para PCL](https://products.aspose.app/email/conversion/eml-to-pcl) com os seguintes benefícios." >}}
