---
title: Converter ICS para MBOX via C #
weight: 1460
url: /pt/net/conversion/ics-to-mbox/
description: Código de amostra para conversão de ICS para MBOX C#. Use o código de exemplo da API para arquivos ICS em lote para conversão MBOX em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter ICS para MBOX via C #" h2="Conversão de ICS para MBOX C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MBOX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ICS" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter ICS para MBOX usando C #" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter ICS em MBOX via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de ICS para MBOX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter ICS para MBOX" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de ICS para MBOX](https://products.aspose.app/email/conversion/ics-to-mbox) com os seguintes benefícios." >}}
