---
title: Converter VCF para MBOX via C #
weight: 3560
url: /pt/net/conversion/vcf-to-mbox/
description: Código de amostra para conversão de VCF para MBOX C#. Use o código de exemplo da API para arquivos VCF em lote para conversão MBOX em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores .NET podem facilmente carregar e converter arquivos VCF para MBOX em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de VCF para MBOX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VCF para MBOX" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de VCF para MBOX](https://products.aspose.app/email/conversion/vcf-to-mbox) com os seguintes benefícios." >}}
