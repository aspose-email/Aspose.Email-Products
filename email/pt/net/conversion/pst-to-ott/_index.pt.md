---
title: Converter PST para OTT via C #
url: /pt/net/conversion/pst-to-ott/
description: Código de amostra para conversão de PST para OTT C#. Use o código de exemplo da API para arquivos PST em lote para conversão OTT em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PST para OTT via C #" h2="Converta PST para OTT sem precisar do Microsoft® Outlook® ou Thunderbird® instalado." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PST para OTT via C #" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos PST para OTT em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo PST com PersonalStorage.FromFile
1. Chame o método SaveAs
1. Passe o arquivo OTT de saída e FileFormat.Ott como parâmetros
1. O arquivo OTT será salvo no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de PST para OTT C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter PST para OTT" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de PST para OTT](https://products.aspose.app/email/conversion/pst-to-ott) com os seguintes benefícios." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" Você obterá instantaneamente o link de download para o arquivo OTT resultante." >}}
