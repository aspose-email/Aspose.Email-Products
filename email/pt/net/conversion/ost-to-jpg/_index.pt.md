---
title: Converta OST para JPG via C #
url: /pt/net/conversion/ost-to-jpg/
description: Código de amostra para conversão de OST para JPG C#. Use o código de exemplo da API para arquivos OST em lote para conversão de JPG em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converta OST para JPG via C #" h2="Converta OST para JPG sem precisar do Microsoft® Outlook® ou Thunderbird® instalado." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="OST" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OST para JPG via C #" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos OST para JPG em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de OST para JPG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter OST para JPG" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de OST para JPG](https://products.aspose.app/email/conversion/ost-to-jpg) com os seguintes benefícios." >}}
