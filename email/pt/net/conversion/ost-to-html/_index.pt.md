---
title: Converter OST para HTML via C #
weight: 3230
url: /pt/net/conversion/ost-to-html/
description: Código de amostra para conversão de OST para HTML C#. Use o código de exemplo da API para arquivos OST em lote para conversão de HTML em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OST para HTML via C #" h2="Conversão de OST para HTML C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OST" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores .NET podem facilmente carregar e converter arquivos OST para HTML em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de OST para HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter OST para HTML" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de OST para HTML](https://products.aspose.app/email/conversion/ost-to-html) com os seguintes benefícios." >}}
