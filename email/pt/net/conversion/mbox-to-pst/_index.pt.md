---
title: Converta MBOX para PST via C #
weight: 1760
url: /pt/net/conversion/mbox-to-pst/
description: Código de exemplo para conversão de MBOX para PST C#. Use o código de exemplo da API para arquivos MBOX em lote para conversão PST em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converta MBOX para PST via C #" h2="Conversão de MBOX para PST C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PST" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MBOX" >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de MBOX para PST C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter MBOX para PST" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão MBOX para PST](https://products.aspose.app/email/conversion/mbox-to-pst) com os seguintes benefícios." >}}
