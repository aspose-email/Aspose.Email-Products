---
title: Converta PST para MHT via C #
url: /pt/net/conversion/pst-to-mht/
description: Código de amostra para conversão de PST para MHT C#. Use o código de exemplo da API para arquivos PST em lote para conversão MHT em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converta PST para MHT via C #" h2="Converta PST para MHT sem precisar do Microsoft® Outlook® ou Thunderbird® instalado." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PST para MHT via C #" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos PST para MHT em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo PST com PersonalStorage.FromFile
1. Chame o método SaveAs
1. Passe o arquivo MHT de saída e FileFormat.Mht como parâmetros
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de PST para MHT C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter PST para MHT" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de PST para MHT](https://products.aspose.app/email/conversion/pst-to-mht) com os seguintes benefícios." >}}
