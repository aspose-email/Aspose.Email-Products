---
title: Converter MSG para OTT via C #
url: /pt/net/conversion/msg-to-ott/
description: Código de amostra para conversão de MSG para OTT C#. Use o código de exemplo da API para arquivos MSG em lote para conversão OTT em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MSG para OTT via C #" h2="Converta MSG para OTT sem precisar do Microsoft® Outlook® ou Thunderbird® instalado." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="MSG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter MSG em OTT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos MSG para OTT em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo MSG com MailMessage.Load.
1. Chame o método Save.
1. Passe o caminho do arquivo de saída com extensão de arquivo OTT.
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de MSG para OTT C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter MSG para OTT" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de MSG para OTT](https://products.aspose.app/email/conversion/msg-to-ott) com os seguintes benefícios." >}}
