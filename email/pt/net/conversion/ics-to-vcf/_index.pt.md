---
title: Converter ICS para VCF via C #
weight: 1150
url: /pt/net/conversion/ics-to-vcf/
description: Código de exemplo para conversão de ICS para VCF C#. Use o código de exemplo da API para arquivos ICS em lote para conversão VCF em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores .NET podem facilmente carregar e converter arquivos ICS para VCF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

+  Carregue o arquivo ICS com MailMessage.Load.
+  Chame o método Save.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de ICS para VCF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter ICS em VCF" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de ICS para VCF](https://products.aspose.app/email/conversion/ics-to-vcf) com os seguintes benefícios." >}}
