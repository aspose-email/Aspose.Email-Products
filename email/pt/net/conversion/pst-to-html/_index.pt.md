---
title: Converta PST para HTML via C #
weight: 2840
url: /pt/net/conversion/pst-to-html/
description: Código de amostra para conversão de PST para HTML C#. Use o código de exemplo da API para arquivos PST em lote para conversão de HTML em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converta PST para HTML via C #" h2="Conversão de PST para HTML C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PST para HTML usando C #" %}}

 Para converter PST em HTML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PST para HTML via C #" %}}
...
+  Arquivo HTML de saída e FileFormat.Html como parâmetros.
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de PST para HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter PST para HTML" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de PST para HTML](https://products.aspose.app/email/conversion/pst-to-html) com os seguintes benefícios." >}}
