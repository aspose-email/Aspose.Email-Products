---
title: Converta MBOX para JPG via C #
url: /pt/net/conversion/mbox-to-jpg/
description: Código de amostra para conversão de MBOX para JPG C#. Use o código de exemplo de API para arquivos MBOX em lote para conversão de JPG em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converta MBOX para JPG via C #" h2="Conversão de MBOX para JPG C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="MBOX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter MBOX para JPG via C #" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos MBOX para JPG em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de MBOX para JPG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter MBOX para JPG" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão MBOX para JPG](https://products.aspose.app/email/conversion/mbox-to-jpg) com os seguintes benefícios." >}}
