---
title: Converta PST para TIFF via C #
url: /pt/net/conversion/pst-to-tiff/
description: Código de amostra para conversão de PST para TIFF C#. Use o código de exemplo da API para arquivos PST em lote para conversão TIFF em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converta PST para TIFF via C #" h2="Converta PST para TIFF sem precisar do Microsoft® Outlook® ou Thunderbird® instalado." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PST para TIFF via C #" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos PST para TIFF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo PST com PersonalStorage.FromFile
1. Chame o método SaveAs
1. Passar arquivo TIFF de saída e FileFormat.Tiff como parâmetros
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de PST para TIFF C#" offSpacer="" %}}

```cs
// load the PST file
using (PersonalStorage personalStorage = PersonalStorage.FromFile("sourceFile.pst"))
{
    personalStorage.SaveAs("outputFile.tiff", FileFormat.Tiff);
}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter PST para TIFF" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de PST para TIFF](https://products.aspose.app/email/conversion/pst-to-tiff) com os seguintes benefícios." >}}
