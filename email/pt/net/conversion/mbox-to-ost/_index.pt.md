---
title: Converter MBOX para OST via C #
weight: 1530
url: /pt/net/conversion/mbox-to-ost/
description: Código de amostra para conversão de MBOX para OST C#. Use o código de exemplo da API para arquivos MBOX em lote para conversão OST em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MBOX para OST via C #" h2="Conversão de MBOX para OST C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OST" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MBOX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter MBOX para OST usando C #" %}}

 Para converter MBOX em OST, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter MBOX em OST via C #" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos MBOX em OST em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de MBOX para OST C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter MBOX em OST" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão MBOX para OST](https://products.aspose.app/email/conversion/mbox-to-ost) com os seguintes benefícios." >}}
