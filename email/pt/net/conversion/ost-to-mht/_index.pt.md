---
title: Converter OST para MHT via C #
url: /pt/net/conversion/ost-to-mht/
description: Código de amostra para conversão de OST para MHT C#. Use o código de exemplo da API para arquivos OST em lote para conversão MHT em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OST para MHT via C #" h2="Converta OST para MHT sem precisar do Microsoft® Outlook® ou Thunderbird® instalado." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="OST" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OST para MHT via C #" %}}
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de OST para MHT C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter OST para MHT" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de OST para MHT](https://products.aspose.app/email/conversion/ost-to-mht) com os seguintes benefícios." >}}
