---
title: Converta MHTML para HTML via C#
weight: 3110
url: /pt/net/conversion/mhtml-to-html/
description: Código de amostra para conversão de MHTML para HTML C#. Use o código de exemplo da API para arquivos MHTML em lote para conversão de HTML em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converta MHTML para HTML via C#" h2="Conversão de MHTML para HTML C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores .NET podem facilmente carregar e converter arquivos MHTML para HTML em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de MHTML para HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter MHTML em HTML" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de MHTML para HTML](https://products.aspose.app/email/conversion/mhtml-to-html) com os seguintes benefícios." >}}
