---
title: Converter ICS para PST via C #
weight: 2030
url: /pt/net/conversion/ics-to-pst/
description: Código de amostra para conversão de ICS para PST C#. Use o código de exemplo da API para arquivos ICS em lote para conversão PST em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter ICS para PST via C #" h2="Conversão de ICS para PST C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PST" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ICS" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter ICS para PST usando C #" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter ICS em PST via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de ICS para PST C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter ICS para PST" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de ICS para PST](https://products.aspose.app/email/conversion/ics-to-pst) com os seguintes benefícios." >}}
