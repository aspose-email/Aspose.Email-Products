---
title: Converter ICS para HTML via C#
weight: 2750
url: /pt/net/conversion/ics-to-html/
description: Código de exemplo para conversão de ICS para HTML C#. Use o código de exemplo da API para arquivos ICS em lote para conversão de HTML em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter ICS para HTML via C#" h2="Conversão de ICS para HTML C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ICS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores .NET podem facilmente carregar e converter arquivos ICS em HTML com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de ICS para HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter ICS em HTML" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de ICS para HTML](https://products.aspose.app/email/conversion/ics-to-html) com os seguintes benefícios." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/email/net/conversion/ics-to-mhtml/" name="ICS TO MHTML" description="Formato de arquivo da página da Web" >}}
