---
title: Converter MBOX para DOCM via C #
url: /pt/net/conversion/mbox-to-docm/
description: Código de amostra para conversão de MBOX para DOCM C#. Use o código de exemplo da API para arquivos MBOX em lote para conversão DOCM em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MBOX para DOCM via C #" h2="Conversão de MBOX para DOCM C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="MBOX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter MBOX em DOCM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos MBOX para DOCM em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de MBOX para DOCM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter MBOX para DOCM" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de MBOX para DOCM](https://products.aspose.app/email/conversion/mbox-to-docm) com os seguintes benefícios." >}}
