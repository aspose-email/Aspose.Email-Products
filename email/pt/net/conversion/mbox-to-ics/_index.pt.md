---
title: Converter MBOX para ICS via C#
weight: 1580
url: /pt/net/conversion/mbox-to-ics/
description: Código de amostra para conversão de MBOX para ICS C#. Use o código de exemplo da API para arquivos MBOX em lote para conversão de ICS em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MBOX para ICS via C#" h2="Conversão de MBOX para ICS C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ICS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MBOX" >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de MBOX para ICS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter MBOX para ICS" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de MBOX para ICS](https://products.aspose.app/email/conversion/mbox-to-ics) com os seguintes benefícios." >}}
