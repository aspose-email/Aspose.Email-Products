---
title: Converter MSG para RTF via C #
url: /pt/net/conversion/msg-to-rtf/
description: Código de amostra para conversão de MSG para RTF C#. Use o código de exemplo da API para arquivos MSG em lote para conversão RTF em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MSG para RTF via C #" h2="Converta MSG para RTF sem precisar do Microsoft® Outlook® ou Thunderbird® instalado." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="RTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="MSG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter MSG em RTF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos MSG para RTF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo MSG com MailMessage.Load.
1. Chame o método Save.
1. Passe o caminho do arquivo de saída com extensão de arquivo RTF.
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de MSG para RTF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter MSG para RTF" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de MSG para RTF](https://products.aspose.app/email/conversion/msg-to-rtf) com os seguintes benefícios." >}}
