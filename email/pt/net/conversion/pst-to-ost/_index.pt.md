---
title: Converta PST para OST via C #
weight: 120
url: /pt/net/conversion/pst-to-ost/
description: Código de amostra para conversão de PST para OST C#. Use o código de exemplo da API para arquivos PST em lote para conversão OST em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converta PST para OST via C #" h2="Conversão de PST para OST C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OST" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PST para OST usando C #" %}}

 Para converter PST em OST, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PST para OST via C #" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos PST para OST em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

+  Carregue o arquivo PST com PersonalStorage.FromFile.
+  Chame o método SaveAs com dois parâmetros.
+  Arquivo OST de saída e FileFormat.Ost como parâmetros.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de PST para OST C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter PST para OST" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de PST para OST](https://products.aspose.app/email/conversion/pst-to-ost) com os seguintes benefícios." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/email/net/conversion/pst-to-msg/" name="PST TO MSG" description="Formato Outlook e Exchange" >}}
