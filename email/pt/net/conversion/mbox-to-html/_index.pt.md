---
title: Converta MBOX para HTML via C #
weight: 2490
url: /pt/net/conversion/mbox-to-html/
description: Código de amostra para conversão de MBOX para HTML C#. Use o código de exemplo de API para arquivos MBOX em lote para conversão de HTML em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converta MBOX para HTML via C #" h2="Conversão de MBOX para HTML C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MBOX" >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de MBOX para HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter MBOX em HTML" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de MBOX para HTML](https://products.aspose.app/email/conversion/mbox-to-html) com os seguintes benefícios." >}}
