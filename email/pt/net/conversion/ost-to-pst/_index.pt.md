---
title: Converter OST para PST via C #
weight: 1870
url: /pt/net/conversion/ost-to-pst/
description: Código de amostra para conversão de OST para PST C#. Use o código de exemplo da API para arquivos OST em lote para conversão PST em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OST para PST via C #" h2="Conversão de OST para PST C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PST" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OST" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores .NET podem facilmente carregar e converter arquivos OST para PST em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de OST para PST C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter OST para PST" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de OST para PST](https://products.aspose.app/email/conversion/ost-to-pst) com os seguintes benefícios." >}}
