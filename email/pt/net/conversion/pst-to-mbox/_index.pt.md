---
title: Converta PST para MBOX via C #
weight: 1430
url: /pt/net/conversion/pst-to-mbox/
description: Código de amostra para conversão de PST para MBOX C#. Use o código de exemplo da API para arquivos PST em lote para conversão MBOX em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converta PST para MBOX via C #" h2="Conversão de PST para MBOX C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MBOX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PST para MBOX usando C #" %}}

 Para converter PST para MBOX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PST para MBOX via C #" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos PST para MBOX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

+  Carregue o arquivo PST com PersonalStorage.FromFile.
+  Chame o método SaveAs com dois parâmetros.
+  Arquivo MBOX de saída e FileFormat.Mbox como parâmetros.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de PST para MBOX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter PST para MBOX" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de PST para MBOX](https://products.aspose.app/email/conversion/pst-to-mbox) com os seguintes benefícios." >}}
