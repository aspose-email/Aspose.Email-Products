---
title: Converter OST para VCF via C #
weight: 2720
url: /pt/net/conversion/ost-to-vcf/
description: Código de amostra para conversão de OST para VCF C#. Use o código de exemplo da API para arquivos OST em lote para conversão VCF em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores .NET podem facilmente carregar e converter arquivos OST para VCF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de OST para VCF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter OST para VCF" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de OST para VCF](https://products.aspose.app/email/conversion/ost-to-vcf) com os seguintes benefícios." >}}
