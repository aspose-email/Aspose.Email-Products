---
title: Converter OLM para EML via C#
url: /pt/net/conversion/olm-to-eml/
description: Código de amostra para conversão de OLM para EML C#. Use o código de exemplo da API para arquivos OLM em lote para conversão EML em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OLM para EML via C#" h2="Converta OLM em EML sem precisar do Microsoft® Outlook® ou Thunderbird® instalado." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="EMAIL" fileiconsmall4="XML" fileiconsmall5="OLM" >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de OLM para EML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter OLM em EML" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de OLM para EML](https://products.aspose.app/email/conversion/olm-to-eml) com os seguintes benefícios." >}}
