---
title: Converter ICS para OFT via C #
weight: 3950
url: /pt/net/conversion/ics-to-oft/
description: Código de amostra para conversão de ICS para OFT C#. Use o código de exemplo da API para arquivos ICS em lote para conversão OFT em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter ICS para OFT via C #" h2="Conversão de ICS para OFT C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OFT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ICS" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter ICS para OFT usando C #" %}}

 Para converter ICS em OFT, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter ICS em OFT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos ICS para OFT em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

+  Carregue o arquivo ICS com Calendar.Appointment.Load.
+  Salve como MSG no MemoryStream.
+  Carregue de MemoryStream para MapiMessage.
+  Chame o método MapiMessage.Save.
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de ICS para OFT C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter ICS para OFT" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de ICS para OFT](https://products.aspose.app/email/conversion/ics-to-oft) com os seguintes benefícios." >}}
