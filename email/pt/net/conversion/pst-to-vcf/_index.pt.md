---
title: Converter PST para VCF via C #
weight: 3280
url: /pt/net/conversion/pst-to-vcf/
description: Código de amostra para conversão de PST para VCF C#. Use o código de exemplo da API para arquivos PST em lote para conversão VCF em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/content h2="Como converter PST para VCF usando C #" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PST para VCF via C #" %}}
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de PST para VCF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter PST para VCF" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de PST para VCF](https://products.aspose.app/email/conversion/pst-to-vcf) com os seguintes benefícios." >}}
