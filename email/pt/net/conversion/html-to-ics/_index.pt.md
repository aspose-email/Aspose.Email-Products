---
title: Converter HTML para ICS via C#
weight: 360
url: /pt/net/conversion/html-to-ics/
description: Código de exemplo para conversão de HTML para ICS C#. Use o código de exemplo da API para arquivos HTML em lote para conversão ICS em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter HTML para ICS via C#" h2="Conversão de HTML para ICS C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ICS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter HTML para ICS usando C#" %}}

 Para converter HTML em ICS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter HTML em ICS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos HTML para ICS em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de HTML para ICS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter HTML para ICS" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de HTML para ICS](https://products.aspose.app/email/conversion/html-to-ics) com os seguintes benefícios." >}}
