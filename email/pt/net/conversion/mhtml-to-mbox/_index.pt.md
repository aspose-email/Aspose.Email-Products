---
title: Converta MHTML para MBOX via C #
weight: 670
url: /pt/net/conversion/mhtml-to-mbox/
description: Código de amostra para conversão de MHTML para MBOX C#. Use o código de exemplo da API para arquivos MHTML em lote para conversão MBOX em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converta MHTML para MBOX via C #" h2="Conversão de MHTML para MBOX C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MBOX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter MHTML para MBOX usando C #" %}}

 Para converter MHTML em MBOX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter MHTML em MBOX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos MHTML para MBOX em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de MHTML para MBOX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter MHTML para MBOX" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de MHTML para MBOX](https://products.aspose.app/email/conversion/mhtml-to-mbox) com os seguintes benefícios." >}}
