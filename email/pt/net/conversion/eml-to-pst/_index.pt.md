---
title: Converter EML para PST via C #
weight: 3730
url: /pt/net/conversion/eml-to-pst/
description: Código de exemplo para conversão de EML para PST C#. Use o código de exemplo da API para arquivos EML em lote para conversão PST em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter EML para PST via C #" h2="Conversão de EML para PST C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PST" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EML" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter EML para PST usando C #" %}}

 Para converter EML em PST, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter EML para PST via C #" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores .NET podem facilmente carregar e converter arquivos EML para PST em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de EML para PST C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter EML para PST" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de EML para PST](https://products.aspose.app/email/conversion/eml-to-pst) com os seguintes benefícios." >}}
