---
title: Converter EML para OST via C #
weight: 3860
url: /pt/net/conversion/eml-to-ost/
description: Código de amostra para conversão de EML para OST C#. Use o código de exemplo da API para arquivos EML em lote para conversão OST em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter EML para OST via C #" h2="Conversão de EML para OST C# usando API .NET sem precisar de Outlook® ou Thunderbird®." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OST" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EML" >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de EML para OST C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter EML para OST" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de EML para OST](https://products.aspose.app/email/conversion/eml-to-ost) com os seguintes benefícios." >}}
