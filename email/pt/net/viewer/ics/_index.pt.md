---
title: Exibir formatos de arquivo ICS via .NET
weight: 3400
url: /pt/net/viewer/ics/
description: Código-fonte C# para carregar, renderizar e exibir documentos ICS em plataformas .NET Framework, .NET Core e Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Visualizador de arquivos ICS para .NET" h2="Visualize ICS sem precisar do Microsoft Outlook ou Thunderbird instalado." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ICS" pfName="Aspose.Email" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ICS" >}}
...
{{% blocks/products/pf/agp/content h2="Como visualizar o arquivo ICS usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para exibir o ICS via C#" %}}
...
1.  Chame o método MailMessage.Save para salvar o ICS no formato HTML
1.  Chamar Process.Start com o caminho para o HTML resultante para carregar o conteúdo ICS no navegador padrão
...
{{% blocks/products/pf/agp/code-block title="Código C# para visualizar o ICS" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Email é uma solução de análise de formatos do Microsoft Outlook e Thunderbird. Pode-se facilmente criar, manipular, converter e-mail e formatos de armazenamento, como MSG, EMLX, EML e MHT. O manuseio de anexos de e-mail, personalização de cabeçalhos de mensagens e implementação de diferentes protocolos de rede como POP3, IMAP e SMTP para enviar e receber e-mails é muito mais fácil. É uma API independente e não requer o Microsoft Outlook ou qualquer outra instalação de software.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para visualizar ICS" sectionDescription="Confira nossas demonstrações ao vivo para [Ver ICS](https://products.aspose.app/email/viewer/ics) com os seguintes benefícios." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar ou configurar nada" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever ou compilar código" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta carregar o arquivo ICS e clicar no botão \"Visualizar\"" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Baixe o arquivo ICS do link, se necessário" >}}
