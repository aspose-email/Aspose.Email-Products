---
title: Gerar relatórios em arquivos PST via .NET
weight: 2930
url: /pt/net/assembly/pst/
description: Código-fonte C# para gerar relatórios em formato PST em plataformas .NET Framework, .NET Core e Xamarin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Geração de relatórios em massa no formato PST via C#" h2="Gere mensagens de e-mail em massa e adicione ao arquivo PST via API .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PST" pfName="Aspose.Email" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2="Como gerar relatórios baseados em PST usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para montar o PST via C #" %}}
...
{{% blocks/products/pf/agp/code-block title="Código de exemplo C# para geração de relatório de mensagem PST" offSpacer="" %}}
