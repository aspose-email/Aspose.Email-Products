---
title: Converter OST para MSG via Java
weight: 3090
url: /pt/java/conversion/ost-to-msg/
description: Exemplo de código de conversão Java para formato OST para arquivo MSG. Use este código de exemplo para exportar a mensagem para MSG em qualquer aplicativo Web ou Desktop baseado em Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OST para MSG em Java" h2="Conversão nativa de OST para MSG usando a biblioteca Java Email, sem a necessidade de nenhum software adicional." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MSG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OST" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter OST para MSG usando Java" %}}

 Para renderizar OST para MSG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OST para MSG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem converter facilmente o arquivo OST para MSG em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

+  Carregue o arquivo OST com PersonalStorage.fromFile.
+  Chame o método saveAs() com dois parâmetros.
+  Arquivo MSG de saída e FileFormat.Ost como parâmetros.
...
{{% blocks/products/pf/agp/code-block title="Converter OST para MSG - Java" offSpacer="" %}}
