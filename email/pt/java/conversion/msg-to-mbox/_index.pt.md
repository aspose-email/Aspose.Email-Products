---
title: Converter MSG para MBOX via Java
weight: 1630
url: /pt/java/conversion/msg-to-mbox/
description: Exemplo de código de conversão Java para formato MSG em arquivo MBOX. Use este código de exemplo para exportar a mensagem para MBOX em qualquer aplicativo Web ou Desktop baseado em Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MSG para MBOX em Java" h2="Conversão nativa de MSG para MBOX usando a biblioteca Java Email, sem a necessidade de nenhum software adicional." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MBOX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MSG" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter MSG para MBOX usando Java" %}}

 Para renderizar MSG para MBOX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter MSG para MBOX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem facilmente converter arquivos MSG para MBOX em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter MSG para MBOX - Java" offSpacer="" %}}
