---
title: Converter VCF para OST via Java
weight: 280
url: /pt/java/conversion/vcf-to-ost/
description: Exemplo de código de conversão Java para formato VCF em arquivo OST. Use este código de exemplo para exportar a mensagem para OST em qualquer aplicativo baseado em Web ou Desktop Java.
---
...
{{% blocks/products/pf/agp/content h2="Como converter VCF para OST usando Java" %}}

 Para renderizar VCF para OST, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VCF para OST via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem facilmente converter arquivos VCF em OST em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter VCF para OST - Java" offSpacer="" %}}
