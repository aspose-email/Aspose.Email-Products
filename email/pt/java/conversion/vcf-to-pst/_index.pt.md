---
title: Converter VCF para PST via Java
weight: 130
url: /pt/java/conversion/vcf-to-pst/
description: Exemplo de código de conversão Java para formato VCF em arquivo PST. Use este código de exemplo para exportar a mensagem para PST em qualquer aplicativo Web ou desktop baseado em Java.
---
...
{{% blocks/products/pf/agp/content h2="Como converter VCF para PST usando Java" %}}

 Para renderizar VCF para PST, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VCF para PST via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem facilmente converter arquivos VCF para PST em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter VCF para PST - Java" offSpacer="" %}}
