...
{{% blocks/products/pf/agp/content h2="Como converter MSG para VCF usando Java" %}}

 Para renderizar MSG para VCF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter MSG em VCF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem facilmente converter arquivos MSG em VCF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter MSG para VCF - Java" offSpacer="" %}}
