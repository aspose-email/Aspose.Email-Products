...
{{% blocks/products/pf/agp/content h2="Como converter ICS para VCF usando Java" %}}

 Para renderizar ICS para VCF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter ICS em VCF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem facilmente converter arquivos ICS em VCF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter ICS para VCF - Java" offSpacer="" %}}
