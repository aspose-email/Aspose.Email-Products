---
title: Converter OFT para MHTML via Java
weight: 3350
url: /pt/java/conversion/oft-to-mhtml/
description: Exemplo de código de conversão Java para formato OFT em arquivo MHTML. Use este código de exemplo para exportar a mensagem para MHTML em qualquer aplicativo Web ou Desktop baseado em Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OFT para MHTML em Java" h2="Conversão nativa de OFT para MHTML usando a biblioteca Java Email, sem a necessidade de nenhum software adicional." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OFT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter OFT para MHTML usando Java" %}}

 Para renderizar OFT para MHTML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OFT para MHTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem facilmente converter arquivos OFT para MHTML em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter OFT para MHTML - Java" offSpacer="" %}}
