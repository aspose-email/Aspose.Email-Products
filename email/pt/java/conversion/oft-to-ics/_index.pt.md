---
title: Converter OFT para ICS via Java
weight: 3550
url: /pt/java/conversion/oft-to-ics/
description: Exemplo de código de conversão Java para formato OFT em arquivo ICS. Use este código de exemplo para exportar a mensagem para o ICS em qualquer aplicativo Web ou Desktop baseado em Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OFT para ICS em Java" h2="Conversão nativa de OFT para ICS usando a biblioteca Java Email, sem a necessidade de nenhum software adicional." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ICS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OFT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter OFT para ICS usando Java" %}}

 Para renderizar OFT para ICS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OFT para ICS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Converter OFT para ICS - Java" offSpacer="" %}}
