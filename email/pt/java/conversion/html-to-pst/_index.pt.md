---
title: Converter HTML para PST via Java
weight: 1380
url: /pt/java/conversion/html-to-pst/
description: Exemplo de código de conversão Java para formato HTML em arquivo PST. Use este código de exemplo para exportar a mensagem para PST em qualquer aplicativo Web ou desktop baseado em Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter HTML para PST em Java" h2="Conversão nativa de HTML para PST usando a biblioteca Java Email, sem a necessidade de nenhum software adicional." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PST" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter HTML para PST usando Java" %}}

 Para renderizar HTML para PST, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter HTML para PST via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem facilmente converter arquivos HTML em PST em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter HTML para PST - Java" offSpacer="" %}}
