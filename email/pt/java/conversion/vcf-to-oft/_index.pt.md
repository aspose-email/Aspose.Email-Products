---
title: Converter VCF para OFT via Java
weight: 1780
url: /pt/java/conversion/vcf-to-oft/
description: Exemplo de código de conversão Java para formato VCF em arquivo OFT. Use este código de exemplo para exportar a mensagem para OFT em qualquer aplicativo Web ou Desktop baseado em Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VCF para OFT em Java" h2="Conversão nativa de VCF para OFT usando a biblioteca Java Email, sem a necessidade de nenhum software adicional." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OFT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VCF" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter VCF para OFT usando Java" %}}

 Para renderizar VCF para OFT, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VCF para OFT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem facilmente converter arquivos VCF para OFT em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter VCF para OFT - Java" offSpacer="" %}}
