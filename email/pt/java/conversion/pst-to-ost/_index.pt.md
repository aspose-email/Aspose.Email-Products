---
title: Converter PST para OST via Java
weight: 1410
url: /pt/java/conversion/pst-to-ost/
description: Exemplo de código de conversão Java para formato PST em arquivo OST. Use este código de exemplo para exportar a mensagem para OST em qualquer aplicativo baseado em Web ou Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PST para OST em Java" h2="Conversão nativa de PST para OST usando a biblioteca Java Email, sem a necessidade de nenhum software adicional." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OST" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PST para OST usando Java" %}}

 Para renderizar PST para OST, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PST para OST via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem facilmente converter arquivos PST em OST em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

+  Carregue o arquivo PST com PersonalStorage.fromFile.
+  Chame o método saveAs() com dois parâmetros.
+  Arquivo OST de saída e FileFormat.Pst como parâmetros.
...
{{% blocks/products/pf/agp/code-block title="Converter PST para OST - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de PST para OST" sectionDescription="[Converter PST para OST](https://products.aspose.app/email/conversion/pst-to-ost) agora mesmo, visitando nosso site de demonstrações ao vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar a API Aspose." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta carregar seu arquivo PST, ele será convertido instantaneamente em OST." >}}
