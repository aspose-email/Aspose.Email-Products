---
title: Converter EML para ICS via Java
weight: 2300
url: /pt/java/conversion/eml-to-ics/
description: Exemplo de código de conversão Java para formato EML em arquivo ICS. Use este código de exemplo para exportar a mensagem para o ICS em qualquer aplicativo Web ou Desktop baseado em Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter EML para ICS em Java" h2="Conversão nativa de EML para ICS usando a biblioteca Java Email, sem a necessidade de nenhum software adicional." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ICS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EML" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter EML para ICS usando Java" %}}

 Para renderizar EML para ICS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter EML para ICS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem facilmente converter arquivos EML para ICS em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter EML para ICS - Java" offSpacer="" %}}
