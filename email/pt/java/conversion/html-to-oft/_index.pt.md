---
title: Converter HTML para OFT via Java
weight: 680
url: /pt/java/conversion/html-to-oft/
description: Exemplo de código de conversão Java para formato HTML em arquivo OFT. Use este código de exemplo para exportar a mensagem para OFT em qualquer aplicativo Web ou Desktop baseado em Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter HTML para OFT em Java" h2="Conversão nativa de HTML para OFT usando a biblioteca Java Email, sem a necessidade de nenhum software adicional." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OFT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter HTML para OFT usando Java" %}}

 Para renderizar HTML para OFT, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter HTML para OFT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem facilmente converter arquivos HTML em OFT em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter HTML para OFT - Java" offSpacer="" %}}
