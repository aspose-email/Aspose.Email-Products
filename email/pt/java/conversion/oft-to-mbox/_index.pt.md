---
title: Converter OFT para MBOX via Java
weight: 1100
url: /pt/java/conversion/oft-to-mbox/
description: Exemplo de código de conversão Java para formato OFT para arquivo MBOX. Use este código de exemplo para exportar a mensagem para MBOX em qualquer aplicativo Web ou Desktop baseado em Java.
---
...
{{% blocks/products/pf/agp/content h2="Como converter OFT para MBOX usando Java" %}}

 Para renderizar OFT para MBOX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OFT para MBOX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem converter facilmente o arquivo OFT em MBOX em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter OFT para MBOX - Java" offSpacer="" %}}
