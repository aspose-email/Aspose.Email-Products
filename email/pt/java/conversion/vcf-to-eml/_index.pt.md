---
title: Converter VCF para EML via Java
weight: 230
url: /pt/java/conversion/vcf-to-eml/
description: Exemplo de código de conversão Java para formato VCF em arquivo EML. Use este código de exemplo para exportar a mensagem para EML em qualquer aplicativo baseado em Web ou Desktop Java.
---
...
{{% blocks/products/pf/agp/content h2="Como converter VCF para EML usando Java" %}}

 Para renderizar VCF para EML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VCF para EML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem facilmente converter arquivos VCF em EML em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter VCF para EML - Java" offSpacer="" %}}
