---
title: Converter OST para HTML via Java
weight: 1910
url: /pt/java/conversion/ost-to-html/
description: Exemplo de código de conversão Java para formato OST em arquivo HTML. Use este código de exemplo para exportar a mensagem para HTML em qualquer aplicativo baseado em Web ou Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OST para HTML em Java" h2="Conversão nativa de OST para HTML usando a biblioteca Java Email, sem a necessidade de nenhum software adicional." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OST" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter OST para HTML usando Java" %}}

 Para renderizar OST para HTML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OST para HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores Java podem converter facilmente o arquivo OST em HTML em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

+  Carregue o arquivo OST com PersonalStorage.fromFile.
+  Chame o método saveAs() com dois parâmetros.
+  Arquivo HTML de saída e FileFormat.Ost como parâmetros.
...
{{% blocks/products/pf/agp/code-block title="Converter OST para HTML - Java" offSpacer="" %}}
