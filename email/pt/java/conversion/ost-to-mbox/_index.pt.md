---
title: Converter OST para MBOX via Java
weight: 1590
url: /pt/java/conversion/ost-to-mbox/
description: Exemplo de código de conversão Java para formato OST para arquivo MBOX. Use este código de exemplo para exportar a mensagem para MBOX em qualquer aplicativo Web ou Desktop baseado em Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OST para MBOX em Java" h2="Conversão nativa de OST para MBOX usando a biblioteca Java Email, sem a necessidade de nenhum software adicional." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MBOX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OST" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter OST para MBOX usando Java" %}}

 Para renderizar OST para MBOX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OST para MBOX via Java" %}}
...
+  Arquivo MBOX de saída e FileFormat.Ost como parâmetros.
...
{{% blocks/products/pf/agp/code-block title="Converter OST para MBOX - Java" offSpacer="" %}}
