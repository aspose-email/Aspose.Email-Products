---
title: Edite ou visualize metadados de arquivos MBOX via Java
weight: 3840
url: /pt/java/metadata/mbox/
description: Código de amostra Java para editar ou visualizar metadados no formato MBOX no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrair metadados MBOX via Java" h2="Crie seus próprios aplicativos Java para adicionar, editar, remover ou extrair metadados de arquivos MBOX usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MBOX" pfName="Aspose.Email" subTitlepfName="para Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Como extrair metadados MBOX usando Java" %}}

 Para obter os metadados do arquivo MBOX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para extrair metadados do MBOX via Java" %}}
...
+  Carregue o arquivo MBOX usando MapiMessage.fromFile
...
{{% blocks/products/pf/agp/code-block title="Extrair Metadados do MBOX - Java" offSpacer="" %}}
