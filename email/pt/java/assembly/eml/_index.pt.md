---
title: Gerar relatórios em arquivos EML via Java
weight: 3980
url: /pt/java/assembly/eml/
description: Código de amostra Java para criar relatórios em formato EML no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Geração de relatórios em massa no formato EML via Java" h2="Gere mensagens de e-mail EML em massa sem precisar do Outlook ou Thunderbird." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EML" pfName="Aspose.Email" subTitlepfName="para Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EML" >}}
...
{{% blocks/products/pf/agp/content h2="Como gerar relatórios EML usando Java" %}}

 Para criar relatórios de arquivo EML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para gerar relatórios EML via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Gerar mensagens eml_Upper em massa - C#" offSpacer="" %}}
