---
title: Converter MBOX para MHTML via aplicativo C++
weight: 1230
url: /pt/cpp/conversion/mbox-to-mhtml/
description: Exemplo de código de conversão C++ para documento MBOX em formato MHTML. Use o código de exemplo para conversão em lote de MBOX para MHTML em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MBOX para MHTML em C++" h2="Conversão MBOX para MHTML de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MBOX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores C++ podem facilmente converter arquivos MBOX para MHTML em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter MBOX para MHTML - C++" offSpacer="" %}}
