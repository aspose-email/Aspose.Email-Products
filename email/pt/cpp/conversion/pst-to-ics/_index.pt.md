---
title: Converta PST para ICS via aplicativo C++
weight: 1920
url: /pt/cpp/conversion/pst-to-ics/
description: Exemplo de código de conversão C++ de documento PST para o formato ICS. Use o código de exemplo para conversão de PST para ICS em lote em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PST para ICS em C++" h2="Conversão de PST para ICS de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ICS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/code-block title="Converter PST para ICS - C++" offSpacer="" %}}
