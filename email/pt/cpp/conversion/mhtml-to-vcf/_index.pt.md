---
title: Converta MHTML para VCF via aplicativo C++
weight: 2110
url: /pt/cpp/conversion/mhtml-to-vcf/
description: Exemplo de código de conversão C++ para documento MHTML em formato VCF. Use o código de exemplo para conversão em lote de MHTML para VCF em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter MHTML para VCF via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores C++ podem facilmente converter arquivos MHTML para VCF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter MHTML para VCF - C++" offSpacer="" %}}
