---
title: Converta OST para MHTML via aplicativo C++
weight: 3040
url: /pt/cpp/conversion/ost-to-mhtml/
description: Exemplo de código de conversão C++ para documento OST em formato MHTML. Use o código de exemplo para conversão em lote de OST para MHTML em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OST para MHTML em C++" h2="Conversão de OST para MHTML de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OST" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter OST para MHTML usando C++" %}}

 Para converter OST para MHTML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OST para MHTML via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores C++ podem facilmente converter arquivos OST para MHTML em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter OST para MHTML - C++" offSpacer="" %}}

```cs
// Load the OST
System::SharedPtr<PersonalStorage> ps = PersonalStorage::FromFile(dataDir + L"sourceFile.ost");
ps->SaveAs(dataDir + L"outputFile.mhtml", Aspose::Email::Outlook::Mhtml::FileFormat::Mhtml); 
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/email/cpp/conversion/ost-to-emlx/" name="OST TO EMLX" description="Formato Apple EMLX" >}}
