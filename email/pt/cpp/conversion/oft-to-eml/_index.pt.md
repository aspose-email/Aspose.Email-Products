---
title: Converta OFT para EML via aplicativo C++
weight: 540
url: /pt/cpp/conversion/oft-to-eml/
description: Exemplo de código de conversão C++ para documento OFT em formato EML. Use o código de exemplo para conversão em lote de OFT para EML em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OFT para EML em C++" h2="Conversão de OFT para EML de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OFT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OFT para EML via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores C++ podem facilmente converter arquivos OFT em EML em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter OFT para EML - C++" offSpacer="" %}}

```cs
// Load the OFT.
System::SharedPtr<MailMessage> oft = MailMessage::Load(u"sourceFile.oft");
// Save in EML
oft->Save(u"convertedFile.eml", SaveOptions::get_DefaultEml()); 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de OFT para EML" sectionDescription="[Converter OFT para EML](https://products.aspose.app/email/conversion/oft-to-eml) agora mesmo, visitando nosso site de demonstrações ao vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar a API Aspose." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta carregar seu arquivo OFT, ele será convertido instantaneamente para EML." >}}
