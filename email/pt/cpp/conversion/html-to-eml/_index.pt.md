---
title: Converta HTML para EML via aplicativo C++
weight: 2610
url: /pt/cpp/conversion/html-to-eml/
description: Exemplo de código de conversão C++ para documento HTML em formato EML. Use o código de exemplo para conversão em lote de HTML para EML em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter HTML para EML em C++" h2="Conversão de HTML para EML de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores C++ podem facilmente converter arquivos HTML em EML em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter HTML para EML - C++" offSpacer="" %}}
