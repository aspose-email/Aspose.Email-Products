---
title: Converta HTML para EMLX via aplicativo C++
weight: 1610
url: /pt/cpp/conversion/html-to-emlx/
description: Exemplo de código de conversão C++ para documento HTML em formato EMLX. Use o código de exemplo para conversão em lote de HTML para EMLX em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter HTML para EMLX em C++" h2="Conversão de HTML para EMLX de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMLX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores C++ podem facilmente converter arquivos HTML para EMLX em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter HTML para EMLX - C++" offSpacer="" %}}

```cs
// Load the HTML.
System::SharedPtr<MailMessage> html = MailMessage::Load(u"sourceFile.html");
// Save in EMLX
html->Save(u"convertedFile.emlx", SaveOptions::CreateSaveOptions(MailMessageSaveType::get_EmlxFormat())); 
