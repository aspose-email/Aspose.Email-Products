---
title: Converter MSG para EMLX via aplicativo C++
weight: 3120
url: /pt/cpp/conversion/msg-to-emlx/
description: Exemplo de código de conversão C++ para documento MSG em formato EMLX. Use o código de exemplo para conversão em lote de MSG para EMLX em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MSG para EMLX em C++" h2="Conversão MSG para EMLX de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMLX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MSG" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores C++ podem facilmente converter arquivos MSG para EMLX em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter MSG para EMLX - C++" offSpacer="" %}}

```cs
// Load the MSG.
System::SharedPtr<MailMessage> msg = MailMessage::Load(u"sourceFile.msg");
// Save in EMLX
msg->Save(u"convertedFile.emlx", SaveOptions::CreateSaveOptions(MailMessageSaveType::get_EmlxFormat())); 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de MSG para EMLX" sectionDescription="[Converter MSG para EMLX](https://products.aspose.app/email/conversion/msg-to-emlx) agora mesmo, visitando nosso site de demonstrações ao vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar a API Aspose." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta carregar seu arquivo MSG, ele será convertido instantaneamente para EMLX." >}}
