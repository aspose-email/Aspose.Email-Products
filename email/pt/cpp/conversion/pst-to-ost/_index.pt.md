---
title: Converta PST para OST via aplicativo C++
weight: 1890
url: /pt/cpp/conversion/pst-to-ost/
description: Exemplo de código de conversão C++ para documento PST em formato OST. Use o código de exemplo para conversão de lote PST para OST em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PST para OST em C++" h2="Conversão de PST para OST de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OST" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores C++ podem facilmente converter arquivos PST em OST em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter PST para OST - C++" offSpacer="" %}}
