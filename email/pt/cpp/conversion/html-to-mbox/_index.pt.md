---
title: Converta HTML para MBOX via aplicativo C++
weight: 740
url: /pt/cpp/conversion/html-to-mbox/
description: Exemplo de código de conversão C++ para documento HTML em formato MBOX. Use o código de exemplo para conversão de lote HTML para MBOX em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter HTML para MBOX em C++" h2="Conversão de HTML para MBOX de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MBOX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter HTML para MBOX via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores C++ podem facilmente converter arquivos HTML em MBOX em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter HTML para MBOX - C++" offSpacer="" %}}

```cs
// Load the HTML.
System::SharedPtr<MailMessage> html = MailMessage::Load(u"sourceFile.html");
// Save in MBOX
html->Save(u"convertedFile.mbox", SaveOptions::get_DefaultMbox()); 
