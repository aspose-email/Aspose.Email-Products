---
title: Converta MHTML para PST via aplicativo C++
weight: 1360
url: /pt/cpp/conversion/mhtml-to-pst/
description: Exemplo de código de conversão C++ para documento MHTML em formato PST. Use o código de exemplo para conversão em lote de MHTML para PST em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MHTML para PST em C++" h2="Conversão MHTML para PST de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PST" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores C++ podem facilmente converter arquivos MHTML para PST em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter MHTML para PST - C++" offSpacer="" %}}
