---
title: Converta OFT para HTML via aplicativo C++
weight: 1060
url: /pt/cpp/conversion/oft-to-html/
description: Exemplo de código de conversão C++ para documento OFT em formato HTML. Use o código de exemplo para conversão em lote de OFT para HTML em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OFT para HTML em C++" h2="Conversão de OFT para HTML de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OFT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores C++ podem facilmente converter arquivos OFT em HTML em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter OFT para HTML - C++" offSpacer="" %}}

```cs
// Load the OFT.
System::SharedPtr<MailMessage> oft = MailMessage::Load(u"sourceFile.oft");
// Save in HTML
oft->Save(u"convertedFile.html", SaveOptions::get_DefaultHtml()); 
