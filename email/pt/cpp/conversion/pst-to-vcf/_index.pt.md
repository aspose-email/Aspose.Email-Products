---
title: Converter PST para VCF via aplicativo C++
weight: 1250
url: /pt/cpp/conversion/pst-to-vcf/
description: Exemplo de código de conversão C++ para documento PST em formato VCF. Use o código de exemplo para conversão em lote de PST para VCF em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/code-block title="Converter PST para VCF - C++" offSpacer="" %}}
