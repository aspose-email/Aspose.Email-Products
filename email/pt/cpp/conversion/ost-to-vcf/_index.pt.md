---
title: Converter OST para VCF via aplicativo C++
weight: 990
url: /pt/cpp/conversion/ost-to-vcf/
description: Exemplo de código de conversão C++ para documento OST em formato VCF. Use o código de exemplo para conversão em lote de OST para VCF em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/content h2="Como converter OST para VCF usando C++" %}}

 Para converter OST para VCF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OST para VCF via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores C++ podem facilmente converter arquivos OST em VCF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter OST para VCF - C++" offSpacer="" %}}
