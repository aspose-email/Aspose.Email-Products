---
title: Converta PST para EMLX via aplicativo C++
weight: 2470
url: /pt/cpp/conversion/pst-to-emlx/
description: Exemplo de código de conversão C++ para documento PST em formato EMLX. Use o código de exemplo para conversão em lote de PST para EMLX em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PST para EMLX em C++" h2="Conversão de PST para EMLX de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMLX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores C++ podem facilmente converter arquivos PST para EMLX em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter PST para EMLX - C++" offSpacer="" %}}
