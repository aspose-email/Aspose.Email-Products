---
title: Converter MBOX para VCF via aplicativo C++
weight: 60
url: /pt/cpp/conversion/mbox-to-vcf/
description: Exemplo de código de conversão C++ para documento MBOX em formato VCF. Use o código de exemplo para conversão em lote de MBOX para VCF em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores C++ podem facilmente converter arquivos MBOX em VCF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter MBOX para VCF - C++" offSpacer="" %}}
