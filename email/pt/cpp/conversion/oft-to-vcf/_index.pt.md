---
title: Converta OFT para VCF via aplicativo C++
weight: 3600
url: /pt/cpp/conversion/oft-to-vcf/
description: Exemplo de código de conversão C++ para documento OFT em formato VCF. Use o código de exemplo para conversão em lote de OFT para VCF em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OFT para VCF via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Os programadores C++ podem facilmente converter arquivos OFT em VCF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter OFT para VCF - C++" offSpacer="" %}}
