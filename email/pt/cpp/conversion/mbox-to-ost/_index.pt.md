---
title: Converter MBOX para OST via aplicativo C++
weight: 3270
url: /pt/cpp/conversion/mbox-to-ost/
description: Exemplo de código de conversão C++ para documento MBOX em formato OST. Use o código de exemplo para conversão de lote MBOX para OST em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MBOX para OST em C++" h2="Conversão MBOX para OST de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OST" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MBOX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores C++ podem facilmente converter arquivos MBOX em OST em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter MBOX para OST - C++" offSpacer="" %}}
