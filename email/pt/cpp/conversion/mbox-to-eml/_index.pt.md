---
title: Converter MBOX para EML via aplicativo C++
weight: 3210
url: /pt/cpp/conversion/mbox-to-eml/
description: Exemplo de código de conversão C++ para documento MBOX em formato EML. Use o código de exemplo para conversão de lote MBOX para EML em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter MBOX para EML em C++" h2="Conversão MBOX para EML de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MBOX" >}}
...
{{% blocks/products/pf/agp/code-block title="Converter MBOX para EML - C++" offSpacer="" %}}
