---
title: Converta HTML para VCF via aplicativo C++
weight: 1880
url: /pt/cpp/conversion/html-to-vcf/
description: Exemplo de código de conversão C++ para documento HTML em formato VCF. Use o código de exemplo para conversão em lote de HTML para VCF em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/content h2="Como converter HTML para VCF usando C++" %}}

 Para converter HTML em VCF, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores C++ podem facilmente converter arquivos HTML em VCF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter HTML para VCF - C++" offSpacer="" %}}

```cs
// Load the HTML.
System::SharedPtr<MailMessage> html = MailMessage::Load(u"sourceFile.html");
// Save in VCF
html->Save(u"convertedFile.vcf", SaveOptions::get_DefaultVcf()); 
