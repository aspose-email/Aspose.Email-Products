---
title: Converter EML para MBOX via aplicativo C++
weight: 500
url: /pt/cpp/conversion/eml-to-mbox/
description: Exemplo de código de conversão C++ para documento EML para o formato MBOX. Use o código de exemplo para conversão de lote EML para MBOX em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter EML para MBOX em C++" h2="Conversão de EML para MBOX de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MBOX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores C++ podem facilmente converter arquivos EML para MBOX em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter EML para MBOX - C++" offSpacer="" %}}
