---
title: Converta OFT para PST via aplicativo C++
weight: 750
url: /pt/cpp/conversion/oft-to-pst/
description: Exemplo de código de conversão C++ para documento OFT no formato PST. Use o código de exemplo para conversão em lote de OFT para PST em qualquer aplicativo C++.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter OFT para PST em C++" h2="Conversão de OFT para PST de alto desempenho usando a biblioteca C++ Email." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PST" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OFT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os programadores C++ podem facilmente converter arquivos OFT para PST em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter OFT para PST - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de OFT para PST" sectionDescription="[Converter OFT para PST](https://products.aspose.app/email/conversion/oft-to-pst) agora mesmo, visitando nosso site de demonstrações ao vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar a API Aspose." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta carregar seu arquivo OFT, ele será convertido instantaneamente em PST." >}}
