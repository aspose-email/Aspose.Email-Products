---
title: Edite ou visualize metadados de documento EML via C++
weight: 3360
url: /pt/cpp/metadata/eml/
description: Código de exemplo C++ para editar ou visualizar metadados de arquivo EML no C++ Runtime Environment para Windows de 32 bits, Windows de 64 bits e Linux de 64 bits.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrair metadados EML via C++" h2="Crie seus próprios aplicativos C++ para adicionar, editar, remover ou extrair metadados de arquivos EML usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/email/aspose_email-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EML" pfName="Aspose.Email" subTitlepfName="para C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Como obter metadados EML usando C++" %}}
